...
// Elasticsearch 색인 문서. search-service의 BoardDocument와 "동일한 boards 인덱스"를 공유하므로 스키마가 일치해야 합니다
// (search-indexer가 writer, search-service의 검색/재색인이 reader). 도메인 IndexedBoard ↔ 이 문서 변환은
