...
// 실패시킵니다. 그 예외는 리스너로 전파돼 기존 에러 핸들러가 재시도 후 각 토픽의 DLQ(board-changed-dlq /
// product-changed-dlq)로 격리합니다 — 이 브레이커(elasticsearch-index)는 board/product 색인 어댑터가 공유합니다
