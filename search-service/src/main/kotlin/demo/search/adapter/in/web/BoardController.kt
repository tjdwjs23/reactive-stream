...
import demo.search.application.port.`in`.BoardPageQuery
import demo.search.application.port.`in`.CreateBoardCommand
import demo.search.application.port.`in`.CreateBoardUseCase
import demo.search.application.port.`in`.DeleteBoardCommand
import demo.search.application.port.`in`.DeleteBoardUseCase
import demo.search.application.port.`in`.GetBoardUseCase
import demo.search.application.port.`in`.UpdateBoardCommand
